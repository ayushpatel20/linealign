...
import { Mail, Phone, Clock, MapPin, CheckCircle, Send, Sparkles, MessageSquare } from "lucide-react";
import { motion } from "framer-motion";

interface FAQContactClientProps {
  settings: {
    websiteName: string;
...
export default function FAQContactClient({ settings }: FAQContactClientProps) {
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-8">
            ...
            <div className="bg-white rounded-[2rem] p-8 border border-slate-150/50 shadow-sm space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-605 text-sm sm:text-base leading-relaxed mt-1 font-semibold">
                      {workingHours}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${contactEmail}`} className="text-primary hover:underline text-sm sm:text-base block mt-1 font-semibold">
                      {contactEmail}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${contactPhone}`} className="text-primary hover:underline text-sm sm:text-base block mt-1 font-semibold">
                      {contactPhone}
                    </a>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <a
                  href={`https://wa.me/${settings.whatsappNumber || "918281778202"}`}
                  target="_blank"
